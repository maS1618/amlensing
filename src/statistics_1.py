'''
This script creats a table which sums up the number of events for certain criteria
...
for cat in cathegories.keys():
	...
	n_s1_nextdecade = [np.sum(nextdecade&shift1&current&dg) for dg in [all_results,deltaG3,deltaG6]]
	n_s05 = [np.sum(shift05&current&dg) for dg in [all_results,deltaG3,deltaG6]]
	n_s05_nextdecade = [np.sum(nextdecade&shift05&current&dg) for dg in [all_results,deltaG3,deltaG6]]
	
	n_l1 = [np.sum(shift1lum&current&dg) for dg in [all_results,deltaG3,deltaG6]]
	n_l1_nextdecade = [np.sum(nextdecade&shift1lum&current&dg) for dg in [all_results,deltaG3,deltaG6]]
	n_l05 = [np.sum(shift05lum&current&dg) for dg in [all_results,deltaG3,deltaG6]]
	n_l05_nextdecade = [np.sum(nextdecade&shift05lum&current&dg) for dg in [all_results,deltaG3,deltaG6]]
	...
	n_mag10_nextdecade = [np.sum(nextdecade&mag10&current&dg) for dg in [all_results,deltaG3,deltaG6]]
	n_mag100 = [np.sum(mag100&current&dg) for dg in [all_results,deltaG3,deltaG6]]
	n_mag100_nextdecade = [np.sum(nextdecade&mag100&current&dg) for dg in [all_results,deltaG3,deltaG6]]
